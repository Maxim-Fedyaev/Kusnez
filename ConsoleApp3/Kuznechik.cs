...
namespace kuznechik
{
    public class KuznyechikEncrypt
    {
        ...
        public byte[] Encrypt(byte[] data)
        {
            ...
            for (int j = 0; j < data.Length/ BLOCK_SIZE; j++)
            {
                Array.Copy(data, BLOCK_SIZE * j, block, 0, BLOCK_SIZE);
                ...
                Array.Copy(block, 0, data, BLOCK_SIZE * j, BLOCK_SIZE);
            }
            return data;
